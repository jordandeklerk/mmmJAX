...
from mmmjax.data.prepare import _prepare_frame, _prepare_panel


def test_data_api_exports_public_entry_points():
    assert mmmjax.data.prepare.__all__ == [
        "Data",
        "ModelInput",
        "PreparedData",
        "Reference",
    ...
    assert Data is mmmjax.data.prepare.Data
    assert PreparedData is mmmjax.data.prepare.PreparedData
    assert not hasattr(PreparedData, "align_to")
    assert not hasattr(PreparedData, "to_jax")
    assert prepare_data is mmmjax.data.prepare.prepare_data
