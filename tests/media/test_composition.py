...
def test_media_response_export_and_empty_series():
    from mmmjax.media.composition import media_response as module_function
...
def test_reach_frequency_export_and_empty_series():
    from mmmjax.media.composition import reach_frequency_response as module_function
